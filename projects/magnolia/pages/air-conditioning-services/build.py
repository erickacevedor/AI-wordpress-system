...
Run:  python3 projects/magnolia/pages/air-conditioning-services/build.py
Then: python3 scripts/validate-page.py projects/magnolia/pages/air-conditioning-services/air-conditioning-services.json
"""
import json, os, sys
...
out = os.path.join(HERE, "air-conditioning-services.json")
